...
struct UpdateCardPINRequest: Codable {
    let reqHeaderInfo: RequestHeaderInfo
    let digestInfo: String = "NA"
    let deviceInfo: DeviceInfo
    let requestKey: RequestKey
    let requestData: UpdateCardPINRequestData
...
struct UpdateCardPINRequestData: Codable {
    let isoReqData: IsoUpdateReqData
...
// MARK: - IsoReqData
struct IsoUpdateReqData: Codable {
    let fld11: String
    let fld12: String
    let fld13: String
    let fld14: String
