...
struct GetMiniStatementRequest: Codable {
...
struct GetMiniStatementRequestData: Codable {
    let isoReqData: GetMiniStatementRequestIsoReqData
...
// MARK: - IsoReqData
struct GetMiniStatementRequestIsoReqData: Codable {
    let fld11: String
    let fld12: String
    let fld13: String
    let fld14: String
